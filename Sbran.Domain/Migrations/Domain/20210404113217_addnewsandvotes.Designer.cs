...
namespace Sbran.Domain.Migrations.Domain
{
    ...
    [Migration("20210404113217_addnewsandvotes")]
    partial class addnewsandvotes
    {
            ...
            modelBuilder.Entity("Sbran.Domain.Entities.ConsularOffice", b =>
                {
                    ...
                    b.Property<string>("TextOfAgreement")
                        .HasColumnType("text")
                        .HasColumnName("TextOfAgreement");
            ...
            modelBuilder.Entity("Sbran.Domain.Entities.VoteList", b =>
                {
                    b.HasOne("Sbran.Domain.Entities.Vote", "Vote")
                        .WithOne()
                        .HasForeignKey("Sbran.Domain.Entities.VoteList", "VoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
